        ...
        <div class="card-body row">
            ...
            <div class="col-md-3 mb-1">
                <div class="form-floating form-control-feedback form-control-feedback-start">
                    ...
                    <select class="form-select @error('comunidad_id') is-invalid @enderror" name="comunidad_id" id="comunidad_id">
                        <option value=""></option>
                        @foreach ($comunidades as $comunidad)
                            <option value="{{ $comunidad->id }}"  {{ old('comunidad_id',$user->comunidad_id)==$comunidad->id?'selected':'' }} >{{ $comunidad->nombre }}</option>
                        @endforeach
                    </select>
            ...
            <div class="col-md-6 mb-1">
                <div class="form-floating form-control-feedback form-control-feedback-start">
                    ...
                    <input name="numero_celular" value="{{ old('numero_celular',$user->numero_celular) }}" type="tel" class="form-control @error('numero_celular') is-invalid @enderror" required >
                    <label>Número celular<i class="text-danger">*</i></label>
