...
@section('breadcrumbs')
{{ Breadcrumbs::render('dispositivos.edit',$dispositivo) }}
@endsection



@section('content')
<form action="{{ route('dispositivos.update',$dispositivo) }}" method="POST" id="formUser" autocomplete="off" >
    @csrf
    @method('put')
    <div class="card">
        ...
        <div class="card-body row">
            ...
            <div class="col-md-12 mb-1">
                <div class="form-floating form-control-feedback form-control-feedback-start">
                    ...
                    <input name="nombre" value="{{ old('nombre',$dispositivo->nombre) }}" type="text" class="form-control @error('nombre') is-invalid @enderror" required autofocus >
            ...
            <div class="col-md-6 mb-1">
                <div class="form-floating form-control-feedback form-control-feedback-start">
                    ...
                    <input name="codigo" value="{{ old('codigo',$dispositivo->codigo) }}" type="text" class="form-control @error('codigo') is-invalid @enderror" >
                    <label>Código</label>
                    @error('codigo')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
            ...
            <div class="col-md-6 mb-1">
                <div class="form-floating form-control-feedback form-control-feedback-start">
                    ...
                    <input name="valor" value="{{ old('valor',$dispositivo->valor) }}" type="text" class="form-control @error('valor') is-invalid @enderror" >
                    <label>Valor</label>
                    @error('valor')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
            ...
            <div class="col-md-6 mb-1">
                <div class="form-floating form-control-feedback form-control-feedback-start">
                    ...
                    <input name="bateria" value="{{ old('bateria',$dispositivo->bateria) }}" type="text" class="form-control @error('bateria') is-invalid @enderror" >
                    <label>Batería</label>
                    @error('bateria')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                ...
                <div class="form-floating form-control-feedback form-control-feedback-start">
                    ...
                    <select class="form-select @error('comercio_id') is-invalid @enderror" name="comercio_id" id="comercio_id" required>
                        ...
                        @foreach ($comercios as $comercio)
                            <option value="{{ $comercio->id }}"  {{ old('comercio_id',$dispositivo->comercio_id)==$comercio->id?'selected':'' }} >{{ $comercio->nombre }}</option>
                        @endforeach
                    </select>
