...
<head>
	...
	{{-- mapa --}}
	<style>
		#modal_scrollable_mapa_content { height: 480px; }
	</style>
...
<body>
	...
	{{-- modal para ver la ubicacion en mapa --}}

	<!-- Scrollable modal -->
	<div id="modal_scrollable_mapa" class="modal fade" tabindex="-1">
		<div class="modal-dialog modal-dialog-scrollable modal-full">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div id="modal_scrollable_mapa_content"></div>
				</div>
