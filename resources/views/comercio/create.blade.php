...
@section('content')
<form action="{{ route('comercios.store') }}" method="POST" id="formUser" enctype="multipart/form-data" autocomplete="off" >
    @csrf
    <div class="card">
        ...
        <div class="card-body row">
            ...
            <div class="col-md-6 mb-1">
                <div class="form-floating form-control-feedback form-control-feedback-start">
                    ...
                    <input name="direccion" value="{{ old('direccion') }}" type="text" class="form-control @error('direccion') is-invalid @enderror" >
            ...
            <div class="col-md-6 mb-1">
                <div class="form-floating form-control-feedback form-control-feedback-start">
                    ...
                    <input name="alarma_comunitaria_id" value="{{ old('alarma_comunitaria_id') }}" type="text" class="form-control @error('alarma_comunitaria_id') is-invalid @enderror" >
