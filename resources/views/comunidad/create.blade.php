        ...
        <div class="card-body row">
            ...
            <div class="col-md-6 mb-1">
                <div class="form-floating form-control-feedback form-control-feedback-start">
                    ...
                    <input name="grupo_whatsapp" value="{{ old('grupo_whatsapp') }}" type="text" class="form-control @error('grupo_whatsapp') is-invalid @enderror" >
            ...
            <div class="col-md-6 mb-1">
                <div class="form-floating form-control-feedback form-control-feedback-start">
                    ...
                    <input name="grupo_telegram" value="{{ old('grupo_telegram') }}" type="text" class="form-control @error('grupo_telegram') is-invalid @enderror" >
